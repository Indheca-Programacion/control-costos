...
if ( file_exists ( "app/Policies/RequisicionOrdenCompraGlobalesPolicy.php" ) ) {
    require_once "app/Policies/RequisicionOrdenCompraGlobalesPolicy.php";
} else {
    require_once "../Policies/RequisicionOrdenCompraGlobalesPolicy.php";
}

use App\Conexion;
use PDO;
use App\Policies\RequisicionOrdenCompraGlobalesPolicy;

class RequisicionOrdenCompraGlobales extends RequisicionOrdenCompraGlobalesPolicy
{
    ...
    protected $tableName = "subgeneros";
