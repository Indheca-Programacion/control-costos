...
if ( file_exists ( "app/Policies/CategoriaProveedorPolicy.php" ) ) {
    require_once "app/Policies/CategoriaProveedorPolicy.php";
} else {
    require_once "../Policies/CategoriaProveedorPolicy.php";
}
...
class CategoriaProveedor  extends CategoriaProveedorPolicy
{
    ...
    protected $tableName = "categoria_proveedores";
