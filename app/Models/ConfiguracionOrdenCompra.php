        ...
        if ( $arrayPerfiles ) {
            ...
            foreach ($arrayPerfiles as $perfil => $perfilEstatus) {
                ...
                foreach ($perfilEstatus as $Estatus => $value) {
                    ...
                    $respuesta = Conexion::queryExecute($this->bdName, "INSERT INTO configuracion_perfil_estatus_ordenes (configuracionOrdenesId, documentoTipo, perfilId, EstatusId, modificar, automatico, usuarioIdCreacion) VALUES (:configuracionOrdenesId, :documentoTipo, (SELECT id FROM perfiles WHERE nombre = :perfil), (SELECT id FROM estatus WHERE descripcion = :EstatusId), :modificar, :automatico, :usuarioIdCreacion)", $insertar, $insertarPDOParam, $error);
        ...
        if ( $arrayFlujo ) {
            ...
            foreach ($arrayFlujo as $estatus => $siguienteEstatus) {
                ...
                foreach ($siguienteEstatus as $Estatus) {
                    ...
                    $respuesta = Conexion::queryExecute($this->bdName, "INSERT INTO configuracion_flujo_ordenes (configuracionOrdenesId, documentoTipo, estatusId, siguienteEstatusId, usuarioIdCreacion) VALUES (:configuracionOrdenesId, :documentoTipo, (SELECT id FROM estatus WHERE descripcion = :estatus), (SELECT id FROM estatus WHERE descripcion = :siguienteEstatus), :usuarioIdCreacion)", $insertar, $insertarPDOParam, $error);
                }
