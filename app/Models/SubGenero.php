...
if ( file_exists ( "app/Policies/SubGeneroPolicy.php" ) ) {
    require_once "app/Policies/SubGeneroPolicy.php";
} else {
    require_once "../Policies/SubGeneroPolicy.php";
}

use App\Conexion;
use PDO;
use App\Policies\SubGeneroPolicy;

class SubGenero extends SubGeneroPolicy
{
