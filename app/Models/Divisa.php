...
if ( file_exists ( "app/Policies/DivisaPolicy.php" ) ) {
    require_once "app/Policies/DivisaPolicy.php";
} else {
    require_once "../Policies/DivisaPolicy.php";
}

use App\Conexion;
use PDO;
use App\Policies\DivisaPolicy;

class Divisa extends DivisaPolicy
{
