...
require_once "../Models/PermisoCategoriaProveedor.php";
...
class PermisoCategoriaProveedorAjax
{
        /*=============================================
        TABLA DE PERMISOS
        =============================================*/
	public function mostrarTabla()
	{
                try{
                        ...
                        $permisos = $permisoCategoriaProveedor->consultar();
                        ...
                        foreach ($permisos as $key => $value) {
                                $rutaEdit = Route::names('permiso-proveedor.edit', $value['id']);
                                $rutaDestroy = Route::names('permiso-proveedor.destroy', $value['id']);
...
TABLA DE PERMISOS
=============================================*/
$activar = new PermisoCategoriaProveedorAjax();
