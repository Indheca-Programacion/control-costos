...
$pdf->logo = $_SERVER['DOCUMENT_ROOT'] . "/vistas/img/empresas/95274811.png";
...
$pdf->MultiCell(20, 9, "Fecha", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(25, 9, "Tipo de Gasto", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(30, 9, "Proveedor", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(20, 9, "Folio", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(15, 9, "Total c/iva", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(30, 9, "Solicitó", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(30, 9, "Destino", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(15, 9, "Equipo No. Economico", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(35, 9, "Descripcion del Concepto", 1, 'C', 1, 0, '', '', true, 0, false, true, '7', 'M');
$pdf->MultiCell(50, 9, "Observaciones ó Justificación", 1, 'C', 1, 1, '', '', true, 0, false, true, '7', 'M');
...
foreach($detallesGastos as $key => $detalle) {
	...
	$pdf->MultiCell(20, $altoFila, "{$fecha}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M',true);
	$pdf->MultiCell(25, $altoFila, "{$tipoGasto}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(30, $altoFila, "{$proveedor}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(20, $altoFila, "{$detalle["factura"]}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(15, $altoFila, "$ {$detalle["costo"]}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(30, $altoFila, "{$solicito}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(30, $altoFila, "{$obra} ", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(15, $altoFila, "{$detalle["economico"]}", 1, 'C', 0, 0, '', '', true, 0, false, true, $altoFila, 'M');
	$pdf->MultiCell(50, $altoFila, "{$observaciones}", 1, 'C', 0, 1, 240, '', true, 0, false, true, $altoFila, 'M',1);
...
while ($y <= 134) {
    ...
    $pdf->MultiCell(20, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
	$pdf->MultiCell(15, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
	$pdf->MultiCell(30, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
	$pdf->MultiCell(30, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
	$pdf->MultiCell(15, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
	$pdf->MultiCell(35, 8, "", 1, 'C', 0, 0, '', '', true, 0, false, true, '7', 'M');
    $pdf->MultiCell(50, 8, "", 1, 'C', 0, 1, '', '', true, 0, false, true, '7', 'M');
	$y = $pdf->getY();
}
$pdf->SetFont('helvetica', '', 7); // Fuente, Tipo y Tamaño
$pdf->MultiCell(20, 7, "Total General", 1, 'C', 0, 0, 95, '', true, 0, false, true, '7', 'M');

$pdf->MultiCell(15, 7, "$ {$totalGeneral}", 1, 'C', 0, 1, '', '', true, 0, false, true, '7', 'M');
...
$pdf->Output("/var/www/html/reportes/tmp/GastosNoDeducibles.pdf", 'F');
