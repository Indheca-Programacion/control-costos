...
$entrego = mb_strtoupper($inventario->entrega);
...
$extension = mb_strtoupper(substr($inventario->firma, -3, 3));
if ( $extension == 'PNG')  $pdf->setJPEGQuality(75); // Calidad de imágen
$pdf->Image($inventario->firma, 10, 230, 50, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);

$extension = mb_strtoupper(substr($recibioFirma, -3, 3));
if ( $extension == 'PNG')  $pdf->setJPEGQuality(75); // Calidad de imágen
$pdf->Image($recibioFirma, 75, 230, 70, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);

$pdf->SetX(10);
$pdf->MultiCell(50, 7, "{$entrego}", 0, 'C', 0, 0, '', '', true);
$pdf->MultiCell(50, 7, "{$solicito}", 0, 'C', 0, 0, 80, '', true);
