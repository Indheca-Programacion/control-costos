$(function(){
  ...
  let tableList = document.getElementById('tablaCategoriaOrdenes');

  // LLamar a la funcion fAjaxDataTable() para llenar el Listado  
  if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/CategoriaOrdenesAjax.php', '#tablaCategoriaOrdenes');
  ...
  $(tableList).on("click", "button.eliminar", function (e) {
    ...
    Swal.fire({
      title: '¿Estás Seguro de querer eliminar esta Categoria (Nombre: '+folio+') ?',
