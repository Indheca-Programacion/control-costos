$(function(){
  ...
  let tableList = document.getElementById('tablaCategoriaProveedores');

  // LLamar a la funcion fAjaxDataTable() para llenar el Listado  
  if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/CategoriaProveedorAjax.php', '#tablaCategoriaProveedores');
