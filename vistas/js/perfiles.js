$(function(){
  ...
  let tableList = document.getElementById('tablaPerfiles');

  // LLamar a la funcion fAjaxDataTable() para llenar el Listado  
  if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/PerfilAjax.php', '#tablaPerfiles');
  ...
  $(tableList).on("click", "button.eliminar", function (e) {
    ...
    Swal.fire({
      title: '¿Estás Seguro de querer eliminar este Perfil (Nombre: '+folio+') ?',
