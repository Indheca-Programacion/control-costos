$(function(){
	...
	let tableList = document.getElementById('tablaIndirectos');

	// LLamar a la funcion fAjaxDataTable() para llenar el Listado
	if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/IndirectoAjax.php', '#tablaIndirectos');

	// Confirmar la eliminación del Indirecto
