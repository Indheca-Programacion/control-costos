            ...
            <div class="card shadow-lg border-left-info">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea disabled name="tiempoEntrega" id="tiempoEntrega" rows="4" class="form-control form-control-sm" required><?= isset($tiempoEntrega) ? $tiempoEntrega : '' ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled name="modalidadEntrega" id="modalidadEntrega" rows="4" class="form-control form-control-sm" required><?= isset($modalidadEntrega) ? $modalidadEntrega : '' ?></textarea>
                        <small class="form-text text-muted">
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled name="distribuidorAutorizado" id="distribuidorAutorizado" rows="4" class="form-control form-control-sm" required><?= isset($distribuidorAutorizado) ? $distribuidorAutorizado : '' ?></textarea>
                        <small class="form-text text-muted">
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled name="recursos" id="recursos" rows="5" class="form-control form-control-sm" required><?= isset($recursos) ? $recursos : '' ?></textarea>
                        <small class="form-text text-muted">
