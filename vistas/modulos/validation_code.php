...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Ingresa el codigo propocionado en el correo electronico.</p>

      <form id="formSend" method="POST" action="<?php echo Route::routes('validation-code'); ?>">

        <input type="hidden" name="_token" value="<?php echo $token?>">

        <div class="input-group mb-3">
          <input type="text" class="form-control form-control-sm" placeholder="Ingresa el codigo" id="codigo" name="codigo" required>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <button type="button" id="btnSend" class="btn btn-primary btn-sm btn-flat">Validar Codigo</button>
          </div>
        </div>
