...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div class="container-fluid">
	      <div class="row mb-2">
	        <div class="col-sm-6">
	          <h1>Empresas <small class="font-weight-light">Crear</small></h1>
	        </div>
	        <div class="col-sm-6">
			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					...
					<div class="card-body">
						...
						<form id="formSend" method="POST" action="<?php echo Route::names('empresas.store'); ?>" enctype="multipart/form-data">
							<?php include "vistas/modulos/empresas/formulario.php"; ?>
							<!-- <input type="button" id="btnSend" class="btn btn-primary" value="Crear empresa"> -->
