<?php
	if ( isset($configuracionRequisicion->id) ) {
		$inicialEstatusId = isset($old["inicialEstatusId"]) ? $old["inicialEstatusId"] : $configuracionRequisicion->inicialEstatusId;

		$usuarioCreacionEliminarPartidas = isset($old["inicialEstatusId"]) ? ( isset($old["usuarioCreacionEliminarPartidas"]) && $old["usuarioCreacionEliminarPartidas"] == "on" ? true : false ) : $configuracionRequisicion->usuarioCreacionEliminarPartidas;
	} else {
            ...
            <div class="card-body">
				...
				<div class="form-group">
					...
					<?php endif; ?>
						...
						<?php if ( $Estatus["requisicionAbierta"] ) : ?>
