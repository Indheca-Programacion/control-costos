	      ...
	      <div class="row mb-2">
	        ...
	        <div class="col-sm-6">
	          <ol class="breadcrumb float-sm-right">
	            ...
	            <li class="breadcrumb-item"><a href="<?=Route::names('orden-compra-centro-servicios.index')?>"> <i class="fas fa-tools"></i> Ordenes de Compra</a></li>
				...
				<div class="col-md-12">
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							...
							<form id="formSend" method="POST" action="<?php echo Route::names('orden-compra-centro-servicios.update', $ordenCompra->id); ?>" enctype="multipart/form-data">
								<input type="hidden" name="_method" value="PUT">
								<?php include "vistas/modulos/orden-compra-cs/formulario.php"; ?>
								<button type="button" id="btnSend" class="btn btn-outline-primary">
									<i class="fas fa-save"></i> Actualizar
								</button>			
								<a href="<?php echo Route::names('orden-compra-centro-servicios.print', $ordenCompra->id); ?>" target="_blank" class="btn btn-info float-right"><i class="fas fa-print"></i> Imprimir</a>				
								<div id="msgSend"></div>
							</form>
...
<?php
	array_push($arrayArchivosJS, 'vistas/js/OrdenCompra.js?v=1');
?>
