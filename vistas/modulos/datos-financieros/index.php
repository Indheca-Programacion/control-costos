    ...
    <section class="content-header bg-white py-3 mb-4 border-bottom shadow-lg">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h1 class="h3 mb-0">Mis Datos Financieros</h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right mb-0">
                        ...
                        <li class="breadcrumb-item active">Mis Datos Financieros</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php include "vistas/modulos/datos-financieros/form-section-marco-financiero.php";?>
                    <!-- Mensaje dinámico -->
...
<?php 
    array_push($arrayArchivosJS, 'vistas/js/datos-financieros.js?v=1.00');
?>
