			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					...
					<div class="card-body">
						...
						<form id="formSend" method="POST" action="<?php echo Route::names('orden-compra.store'); ?>" enctype="multipart/form-data">
...
<?php
	array_push($arrayArchivosJS, 'vistas/js/ordenes-compra.js?v=1.17');
?>
