...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form id="formSend" method="POST" action="<?php echo Route::routes('change-password'); ?>">

        <input type="hidden" name="_token" value="<?php echo createTemporaryToken(); ?>">

        <div class="input-group mb-3">
          <input type="text" class="form-control form-control-sm" placeholder="Nueva contraseña" id="contrasena" name="contrasena" required>
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control form-control-sm" placeholder="Confirma la contraseña" id="confirmar-contrasena" name="confirmar-contrasena" required>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-key"></span>
            </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <button type="button" id="btnSend" class="btn btn-primary btn-sm btn-flat">Cambiar Contraseña</button>
          </div>
        </div>
