<?php
	if ( isset($gastosTipos->id) ) {
		$descripcion = isset($old["descripcion"]) ? $old["descripcion"] : $gastosTipos->descripcion;
		$nombreCorto = isset($old["nombreCorto"]) ? $old["nombreCorto"] : $gastosTipos->nombreCorto;
	} else {
