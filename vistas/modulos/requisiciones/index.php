          ...
          <div class="card card-secondary card-outline">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="<?=Route::names('requisiciones.create')?>" class="btn btn-outline-primary mr-1 ">
              ...
              <div class="card card-body mb-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group input-group-sm mb-2" style="flex-wrap: nowrap;">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="filtroCategoriaId">Categorias:</label>
                      </div>
                      <select class="custom-select select2" id="filtroCategoriaId">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group input-group-sm mb-2" style="flex-wrap: nowrap;">
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="filtroProveedorId">Proveedores:</label>
                      </div>
                      <select class="custom-select select2" id="filtroProveedorId">
                        <option value="0" selected>Proveedor</option>
                        <?php foreach($proveedores as $proveedor) { ?>
                          <option value="<?php echo $proveedor["id"]; ?>">
                            <?php echo mb_strtoupper(fString($proveedor["razonSocial"])); ?>
                          </option>
                        <?php } ?>
                      </select>
                    </div>
...
<?php
  array_push($arrayArchivosJS, 'vistas/js/requisiciones.js?v=1.00');
?>
