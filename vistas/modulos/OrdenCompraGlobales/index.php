...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Ordenes de Compra Globales<small class="font-weight-light">Listado</small></h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?=Route::routes('inicio')?>"> <i class="fas fa-tachometer-alt"></i> Inicio</a></li>
            <li class="breadcrumb-item active">Ordenes de Compra Globales</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-secondary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Listado de Ordenes de Compra Globales
              </h3>
              <div class="card-tools">
                <a href="<?=Route::names('orden-compra-globales.create')?>" class="btn btn-outline-primary mr-1">
...
<?php
  array_push($arrayArchivosJS, 'vistas/js/OrdenCompraGlobales.js?v=2.00');
?>
