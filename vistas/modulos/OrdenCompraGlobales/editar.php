				...
				<div class="col-md-12">
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							...
							<form id="formSend" method="POST" action="<?php echo Route::names('orden-compra-globales.update', $ordenCompraGlobal->id); ?>" enctype="multipart/form-data">
								...
								<a href="<?php echo Route::names('orden-compra-globales.print', $ordenCompraGlobal->id); ?>" target="_blank" class="btn btn-info float-right"><i class="fas fa-print"></i> Imprimir</a>				
								<div id="msgSend"></div>
							</form>
